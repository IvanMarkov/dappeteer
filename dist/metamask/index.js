...
const setSpendingCap_1 = require("./setSpendingCap");
...
const getMetaMask = (page) => {
  ...
  const getSingedIn = () => {
    const evaluateFn = () =>
      window.signedIn !== undefined ? window.signedIn : true;
  ...
  return new Promise((resolve) => {
    resolve({
      ...
      setSpendingCap: (0, setSpendingCap_1.setSpendingCap)(page),
      approve: (0, approve_1.approve)(page),
      confirmTransaction: (0, confirmTransaction_1.confirmTransaction)(
        page,
        getSingedIn
      ),
      ...
      snaps: {
        ...
        getNotificationEmitter: (0,
        getNotificationEmitter_1.getNotificationEmitter)(page),
